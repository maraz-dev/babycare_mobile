...
class SignIn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: authAppBar(context, 'Sign In', 'Please enter your credentials to proceed', true),
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10,),
            ButtonWidget(text: 'LOGIN', press: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const SignUp())), BackgroundColor: primaryColor, radius: 4,),
            const SizedBox(height: 10,),
