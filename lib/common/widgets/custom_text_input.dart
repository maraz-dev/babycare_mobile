...
class _CustomTextInputState extends State<CustomTextInput> {
  ...
  OutlineInputBorder getBorder() {
    return OutlineInputBorder(
      ...
      borderSide: BorderSide(width: 0.1, color: widget.themeColor ?? Theme.of(context).primaryColor),
      gapPadding: 2,
    );
  }
  ...
  Widget getSuffixIcon() {
    ...
    else if (widget.inputType == InputType.Search) {
      return IconButton(
        onPressed: () {
          visibility = !visibility;
          setState(() {});
...
//input types
enum InputType { Default, Email, Number, Password, PaymentCard, Search }